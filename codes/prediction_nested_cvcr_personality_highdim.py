...
# -------------------------------------------------------------------------------------------------------------------------------------------------
X = np.loadtxt('../data/Feature_for_Personality_N269_HighDim.csv', delimiter=',')
y = np.loadtxt('../data/Personal_' + TRAIT_NAME + '_for_Personality_N269_HighDim.csv', delimiter=',')
V = np.loadtxt('../data/BrainVolume_for_Personality_N269_HighDim.csv', delimiter=',')
SG = np.loadtxt('../data/SG_Personal_' + TRAIT_NAME + '_for_Personality_N269_HighDim.csv', delimiter=',')
AGE = np.loadtxt('../data/Age_for_Personality_N269_HighDim.csv', delimiter=',')
S = np.loadtxt('../data/Sex_Personal_for_Personality_N269_HighDim.csv', delimiter=',')
...
# Save results
# ------------
# np.savetxt('../prediction/HCP_N269_HighDim_NestedCV_CORR_Personal_' + TRAIT_NAME + '_' + CONDITION + '_PEARSON_R_TRAIN.txt', REPORT_TRAIN)
# np.savetxt('../prediction/HCP_N269_HighDim_NestedCV_CORR_Personal_' + TRAIT_NAME + '_' + CONDITION + '_PEARSON_R_TEST.txt', REPORT_TEST)
# np.savetxt('../prediction/HCP_N269_HighDim_NestedCV_CORR_Personal_' + TRAIT_NAME + '_' + CONDITION + '_CV_TRAIN_INDEX.txt', TRAIN_INDEX)
# np.savetxt('../prediction/HCP_N269_HighDim_NestedCV_CORR_Personal_' + TRAIT_NAME + '_' + CONDITION + '_PREDICTED_Y.txt', PREDICTED_Y)
# np.savetxt('../prediction/HCP_N269_HighDim_NestedCV_CORR_Personal_' + TRAIT_NAME + '_' + CONDITION + '_BETA.txt', BETA)
