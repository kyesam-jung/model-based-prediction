...
# Save results
# ------------
np.savetxt('../classification/HCP_N270_' + PARAMETER_DIM + '_NestedCV_' + CONDITION + '_ACCURACY_TRAIN.txt', REPORT_TRAIN, fmt=["%.1f", "%.1f", "%.18f"])
np.savetxt('../classification/HCP_N270_' + PARAMETER_DIM + '_NestedCV_' + CONDITION + '_ACCURACY_TEST.txt', REPORT_TEST, fmt=["%.1f", "%.1f", "%.18f"])
np.savetxt('../classification/HCP_N270_' + PARAMETER_DIM + '_NestedCV_' + CONDITION + '_CV_TRAIN_INDEX.txt', TRAIN_INDEX, fmt="%.1f")
np.savetxt('../classification/HCP_N270_' + PARAMETER_DIM + '_NestedCV_' + CONDITION + '_PROBA.txt', PROBABILITY)
np.savetxt('../classification/HCP_N270_' + PARAMETER_DIM + '_NestedCV_' + CONDITION + '_BETA.txt', BETA)

if CONDITION == "EMPSIM":
    np.savetxt('../classification/HCP_N270_' + PARAMETER_DIM + '_NestedCV_' + CONDITION + '_SHAP_SUBJECT.txt', SHAP_SUBJECT_NP, fmt=["%.1f", "%.1f", "%.1f", "%.18f", "%.18f", "%.18f", "%.18f"])

if CONDITION == "EMP" or CONDITION == "SIM":
    np.savetxt('../classification/HCP_N270_' + PARAMETER_DIM + '_NestedCV_' + CONDITION + '_SHAP_SUBJECT.txt', SHAP_SUBJECT_NP, fmt=["%.1f", "%.1f", "%.1f", "%.18f", "%.18f"])

np.savetxt('../classification/HCP_N270_' + PARAMETER_DIM + '_NestedCV_' + CONDITION + '_SHAP_BASE.txt', SHAP_BASE_NP, fmt=["%.1f", "%.1f", "%.18f"])
