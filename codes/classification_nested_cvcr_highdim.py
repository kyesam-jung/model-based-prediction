...
# ---------------------------------------------------------------------------------------------------------------
X = np.loadtxt('../data/Feature_for_Classification_N270_HighDim.csv', delimiter=',')
y = np.loadtxt('../data/Female_Male_for_Classification_N270_HighDim.csv', delimiter=',')
V = np.loadtxt('../data/BrainVolume_for_Classification_N270_HighDim.csv', delimiter=',')
...
# Save results
# ------------
# np.savetxt('../classification/HCP_N270_HighDim_NestedCV_' + CONDITION + '_ACCURACY_TRAIN.txt', REPORT_TRAIN)
# np.savetxt('../classification/HCP_N270_HighDim_NestedCV_' + CONDITION + '_ACCURACY_TEST.txt', REPORT_TEST)
# np.savetxt('../classification/HCP_N270_HighDim_NestedCV_' + CONDITION + '_CV_TRAIN_INDEX.txt', TRAIN_INDEX)
# np.savetxt('../classification/HCP_N270_HighDim_NestedCV_' + CONDITION + '_PROBA.txt', PROBABILITY)
# np.savetxt('../classification/HCP_N270_HighDim_NestedCV_' + CONDITION + '_BETA.txt', BETA)
