...
# -------------------------------------------------------------------------------------------------------------------------------------------------
X = np.loadtxt('../data/Feature_for_CogTotalComp_Unadj_N268_HighDim.csv', delimiter=',')
y = np.loadtxt('../data/CogTotalComp_Unadj_for_CogTotalComp_Unadj_N268_HighDim.csv', delimiter=',')
V = np.loadtxt('../data/BrainVolume_for_CogTotalComp_Unadj_N268_HighDim.csv', delimiter=',')
SG = np.loadtxt('../data/SG_CogTotalComp_Unadj_for_CogTotalComp_Unadj_N268_HighDim.csv', delimiter=',')
AGE = np.loadtxt('../data/Age_for_CogTotalComp_Unadj_N268_HighDim.csv', delimiter=',')
...
# Save results
# ------------
np.savetxt('../prediction/HCP_N268_HighDim_NestedCV_CORR_COG_' + CONDITION + '_PEARSON_R_TRAIN.txt', REPORT_TRAIN)
np.savetxt('../prediction/HCP_N268_HighDim_NestedCV_CORR_COG_' + CONDITION + '_PEARSON_R_TEST.txt', REPORT_TEST)
np.savetxt('../prediction/HCP_N268_HighDim_NestedCV_CORR_COG_' + CONDITION + '_CV_TRAIN_INDEX.txt', TRAIN_INDEX)
np.savetxt('../prediction/HCP_N268_HighDim_NestedCV_CORR_COG_' + CONDITION + '_PREDICTED_Y.txt', PREDICTED_Y)
np.savetxt('../prediction/HCP_N268_HighDim_NestedCV_CORR_COG_' + CONDITION + '_BETA.txt', BETA)
